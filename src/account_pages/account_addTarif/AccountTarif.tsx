  ...
  return (
    <div className="container max-w-[1250px] mx-auto ">
      ...
      <div className="flex gap-8">
        <div className=" bg-[#fff] py-[30px] px-[35px] justify-between">
          {TARIF_ITEM.map((item) => (
            <div className="flex items-center gap-5 border-2 p-5 mb-4">
              <div className="flex items-center bg-[#F3F3F4] rounded-sm py-3 px-5 justify-center w-[150px]">
                <span className="text-5xl font-semibold text-[#1875F0]">
                  {item.quantity}
                </span>
              ...
              <p className="text-sm text-[#76767A] ml-14">
                Дополнительный {item.text} ГБ
              </p>
              <button className="py-5 px-10 ml-11 border-[#1875F0] text-sm font-medium text-[#1875F0]">
                Выбрать
              </button>
            </div>
          ))}
        </div>
        <aside className="py-[30px] px-[35px] max-w-[360px] w-full max-h-[300px] bg-[#fff]">
