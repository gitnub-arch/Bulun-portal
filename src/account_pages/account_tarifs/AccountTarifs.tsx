...
import { RadioGroup, RadioGroupItem } from "@/components/ui/radio-group"; // Импортируем RadioGroup и RadioGroupItem
  ...
  return (
    <div className="container max-w-[1250px] mx-auto">
      <div className="bg-[#fff] py-5 px-9 mt-5 max-w-[845px] rounded-lg">
        <h2 className="text-2xl font-semibold mb-5">Текущий тарифный план</h2>
      ...
      <div className="bg-[#fff] py-5 px-9 mt-5 max-w-[845px] rounded-lg">
        ...
        <Separator className="mb-6" />
        <div className="flex">
          <Button className="ml-auto px-36 py-3">Оформить</Button>
        </div>
      </div>
    </div>
  );
